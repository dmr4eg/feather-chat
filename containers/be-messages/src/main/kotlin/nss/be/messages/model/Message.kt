...
data class Message(
        ...
        @NotNull
        @field:Valid
        @Schema(example = "{ \"chatUUID\": \"665c599d-5c8d-4d20-aaab-7ffaba150606\", \"senderUUID\": \"665c599d-5c8d-4d20-aaab-7ffaba150606\", \"timestamp\": 1627846382000}", required = true, description = "")
